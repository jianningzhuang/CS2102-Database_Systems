...
--Invalid health declaration. Not in range.
CALL declare_health (1001, CURRENT_DATE-2, 31.0);
CALL declare_health (1001, CURRENT_DATE-3, 44.0);

--Invalid health declaration. Declaration already made.
CALL declare_health (1001, CURRENT_DATE, 36.0);
...
SELECT * FROM non_compliance(CURRENT_DATE - 3, CURRENT_DATE - 4);
...
-- Booking on fever day with the fever (1001, 1004 Traced)
...
-- To test out the following trigger test cases, may need to reload the 3 files after each test. 
...
--UPDATE Employees SET resigned_date = CURRENT_DATE WHERE eid = 1018; --#12-51 5-6 will become unapproved. #13-51 1-3 will be removed. #11-51 2-3 1018 removed as participant. 
...
--UPDATE updates SET new_capacity = 2 WHERE floor_num = 12 AND room_num = 51; --#12-51 5-6 will be removed. #12-51 6-7 will be removed. 
...
--Additional trigger test cases, also integrated within test cases above
